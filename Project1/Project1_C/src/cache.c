...
// Example: print_error_exit("Error: Could not allocate memory at %d", __LINE__);
...
// Define data structures, globals and any helper functions you might need for simulating
...
{
    // MAKE SURE TO FREE UP ANY DYNAMICALLY ALLOCATED MEMORY
